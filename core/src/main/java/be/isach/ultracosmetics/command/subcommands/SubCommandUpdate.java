    ...
    protected void onExeAnyone(CommandSender sender, String[] args) {
        ...
        if (args.length > 1 && args[1].equalsIgnoreCase("force")) {
            sender.sendMessage(ChatColor.RED +
                    "Ignoring version check and downloading anyway. This is not recommended and may result in a downgrade.");
        } else {
        ...
        sender.sendMessage(ChatColor.GREEN + "UltraCosmetics " + updateManager.getModrinthVersion() +
